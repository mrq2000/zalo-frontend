    ...
    <View style={styles.postItemWrapper}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfoWrapper}>
          <Text style={styles.userInfo}><Text style={styles.userName}>Phạm Trung Hiếu</Text><Text style={styles.userAction}> đã thay đổi ảnh đại diện</Text></Text>
      ...
      <View style={styles.body}>
        <Text style={styles.bodyText}>Hôm nay trời đẹp quá https://cellphones.com.vn/sforum/wp-content/uploads/2021/09/photo-1-1615870720601745881145.jpg</Text>
        <Image 
